...
generator.load_state_dict(torch.load('weights/target_vgg16bn_unet_avenue_mid_256_90000.pth')['net_g'])
...
while training:
    for indice, clips, flow_strs in train_dataloader:
        ...
        if len(new_areas)!=0:
            ...
            save_image(((tframe_4[2]+1)/2),f'crop_imgs/tester_mid_4.png')
            save_image(((tframe_5[3]+1)/2),f'crop_imgs/tester_mid_5.png')
            ...
            f_input = torch.cat([frame_1[0],frame_2[1], frame_4[2], frame_5[3]], 0)
