...
class VGGUnet(nn.Module):
    ...
    def __init__(self, encoder, *, pretrained=False, out_channels=2):
        ...
        self.block0 = nn.Sequential(nn.Conv2d(12,64,3,padding=1,bias=False))
        self.block1 = nn.Sequential(*self.encoder[1:6])
...
def vgg13bn_unet(output_dim: int=3, pretrained: bool=False):
    return VGGUnet(vgg13_bn, pretrained=pretrained, out_channels=output_dim)


def vgg16bn_unet(output_dim: int=3, pretrained: bool=False):
