            ...
            for j, clip in enumerate(dataset):
                ...
                if len(new_areas) != 0:
                    ...
                    for k, area in enumerate(new_areas):
                        crop_img_1 = TT(img_1.crop(area).resize((input_size,input_size))).view([1,3,input_size,input_size])
                        crop_img_2 = TT(img_2.crop(area).resize((input_size,input_size))).view([1,3,input_size,input_size])
                        crop_img_3 = TT(img_3.crop(area).resize((input_size,input_size))).view([1,3,input_size,input_size])
                        crop_img_4 = TT(img_4.crop(area).resize((input_size,input_size))).view([1,3,input_size,input_size])
                        crop_img_t = TT(img_t.crop(area).resize((input_size,input_size))).view([1,3,input_size,input_size])
