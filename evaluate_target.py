...
def val(cfg, model=None):
    ...
    np.save("scores/score_discriminator_resize_64", saves)
    np.save("scores/psnr_resize_64_mean", psnr_source_mean)
    np.save("scores/psnr_resize_64_min", psnr_source_min)
    np.save("scores/psnr_resize_64_max", psnr_source_max)
